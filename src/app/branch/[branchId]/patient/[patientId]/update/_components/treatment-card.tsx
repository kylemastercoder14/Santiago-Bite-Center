...
const TreatmentCard = ({ initialData }: { initialData: PatientProps }) => {
  ...
  const form = useForm<z.infer<typeof TreatmentFormValidators>>({
    ...
    defaultValues: {
      treatmentDate: initialData?.treatment[0]?.treatmentDate ?? "",
      biteCenter: initialData?.treatment[0]?.biteCenter ?? "",
      tetanusToxoid: initialData?.treatment[0]?.tetanusToxoid ?? "",
      tetanusImmunuglobulin:
        initialData?.treatment[0]?.tetanusImmunuglobulin ?? "",
      tetanusSerum: initialData?.treatment[0]?.tetanusSerum ?? "",
      antiRabiesSerum: initialData?.treatment[0]?.antiRabiesSerum ?? "",
      chickEmbryoCellVaccine:
        initialData?.treatment[0]?.chickEmbryoCellVaccine ?? "",
      verocellRabiesVaccine:
        initialData?.treatment[0]?.verocellRabiesVaccine ?? "",
    },
  });
